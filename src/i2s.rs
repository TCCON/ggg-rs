...
impl I2SLineIter {
    ...
    pub fn new(i2s_reader: FileBuf<BufReader<File>>, i2s_version: I2SVersion) -> Self {
        Self { file: i2s_reader, curr_param: 0, i2s_version }
    }
}

impl Iterator for I2SLineIter {
...
fn iter_i2s_lines_inner(file: &mut FileBuf<BufReader<File>>, curr_param: usize, param_num_lines: usize, max_n_param: Option<usize>) -> Option<std::io::Result<(bool, String)>> {
